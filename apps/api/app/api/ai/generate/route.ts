/**
 * Relay BYOK générique — même contrat que `/api/exercise/generate`.
 * Stateless : clé et prompts uniquement en mémoire de la requête.
 */
import { z } from "zod";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return errorResponse(
      request,
      {
        error: "Corps JSON invalide. Envoyez { impulse, technique }.",
